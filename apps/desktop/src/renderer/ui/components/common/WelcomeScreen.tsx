...
export function WelcomeScreen({ onAddChannel, onOpenSettings }: WelcomeScreenProps) {
  return (
      ...
      <div className="welcome-screen__content">
        <div className="welcome-screen__hero">
          ...
          <p className="welcome-screen__subtitle">
            One chat to rule them all. Connect Twitch, Kick, YouTube, and TikTok in a single friendly desk.
          </p>
        </div>
        ...
        <div className="welcome-screen__actions">
          <button className="welcome-screen__button welcome-screen__button--primary" onClick={onAddChannel} type="button">
            <span className="welcome-screen__button-icon" aria-hidden="true">
              ➕
            </span>
            Add Your First Channel
          </button>
          <button className="welcome-screen__button welcome-screen__button--secondary" onClick={onOpenSettings} type="button">
            <span className="welcome-screen__button-icon" aria-hidden="true">
              ⚙️
            </span>
            Open Settings
        ...
        <div className="welcome-screen__features">
          <div className="feature-card">
            ...
            <p className="feature-card__description">See all your chats in one place with clear platform indicators.</p>
          </div>
          <div className="feature-card">
            <span className="feature-card__icon" aria-hidden="true">
              ⚡
            ...
            <p className="feature-card__description">Apply quick moderation actions without leaving the feed.</p>
          </div>
          <div className="feature-card">
            <span className="feature-card__icon" aria-hidden="true">
              🎨
            ...
            <p className="feature-card__description">Themes, filters, and layout controls tailored to your workflow.</p>
          </div>
        </div>
      </div>
    </div>
